...
import { descContent } from './branding-util';

import { GettingStartedWidget } from 'getting-started/lib/browser/getting-started-widget';
...
export class TheiaIDEGettingStartedWidget extends GettingStartedWidget {
    ...
    protected async doInit(): Promise<void> {
        super.doInit();
        this.themeService.setCurrentTheme("Default Dark+");
